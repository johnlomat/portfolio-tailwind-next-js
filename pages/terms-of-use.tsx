        ...
        <div className="container flex flex-wrap space-y-6">
          <div className="flex w-full flex-col items-center space-y-20">
            <div className="w-full max-w-3xl rounded-lg bg-white p-6 shadow-md">
              ...
              <p className="mb-4">
                Welcome to my portfolio website. By accessing or using this
                ...
                policy govern my relationship with you in relation to this
                website.
              </p>
              <p className="mb-4">
                The term &lsquo;I&lsquo; or &lsquo;me&lsquo; refers to the owner
                of the website. The term &lsquo;you&lsquo; refers to the user or
              ...
              <p className="mb-4">
                ...
                me. This material includes, but is not limited to, the design,
              ...
              <p className="mb-4">
                ...
                encourage a criminal offense; transmit or distribute a virus,
                trojan, worm, logic bomb or any other material which is
                malicious, technologically harmful, in breach of confidence or
                in any way offensive or obscene; hack into any aspect of the
                service; corrupt data; cause annoyance to other users; infringe
                upon the rights of any other person&lsquo;s proprietary rights;
                send any unsolicited advertising or promotional material,
                commonly referred to as &quot;spam&quot;; or attempt to affect
                the performance or functionality of any computer facilities of
              ...
              <p className="mb-4">
                ...
                is&quot; basis. To the fullest extent permitted by law, I
                exclude all liability for any loss or damage arising out of or
              ...
              <p className="mb-4">
                I may revise these terms of use at any time without notice. By
                using this website, you agree to be bound by the current version
